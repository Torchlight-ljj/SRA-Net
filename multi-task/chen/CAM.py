...
class Cam():
    ...
    def get_cam(self, img_path, out_dir):
        ...
        self.Net.down4.register_forward_hook(self.farward_hook)
        self.Net.down4.register_backward_hook(self.backward_hook)
        ...
        # forward
        seg, output = self.Net(img_variable)
...
for img in img_list:
    CAM = Cam(Net,'./data/save/4.pth',512,'refine',True)
